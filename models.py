...
class User(db.Model, UserMixin):
    ...
    def __repr__(self):
        return f"You're account at {self.email} has been added to the Database."
...
class Car(db.Model):
    ...
    def __init__(self, year, make, model, cost, user_token, id = ''):
        self.id = self.set_id()
        self.year = year
        self.make = make
        self.model = model
    ...
    def __repr__(self):
        return f'The following vehicle has been added to the collection: {self.year} {self.make} {self.model}'
...
class CarSchema(ma.Schema):
    class Meta:
        fields = ['id', 'year', 'make', 'model', 'cost']
